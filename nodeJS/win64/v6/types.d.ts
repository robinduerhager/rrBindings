...
export interface rrBinding {
    ...
    rrGlobal(): rrGlobal;
    datafiles(): DataFiles;
    createUserSettings(): _rrUserSettings;
    createRRJob(): rrJob;
    rrUint64(): rrUint64;
    _dataIDs: _EdataIDs;
    _filterIDs: _EfilterIDs;
    _sortIDs: _EsortIDs;
}
// ----- libpyRR2 conversion BEGIN -----
interface _rrTCP {
    // ----- VARIABLES -----
     ...
     */
    jobGetInfoBasic(jobID?: rrUint64): boolean;
     ...
     */
    jobGetInfoSend(jobID?: rrUint64): boolean;
     ...
     */
    jobSendCommand(jobIDs: rrUint64[], commandID: number, parameter: number): boolean;
     ...
     * @returns true if the operation succeeded
     */
    jobModify(jobID: rrUint64[], settings: _SettingsOnly, changeFlags: _SettingsOnly): boolean;
     ...
     * @returns true if the operation succeeded
     */
    jobSubmitNew(newJob: _JobBasics, overrideParameter: string): boolean;
     ...
     * @returns true if the operation succeeded.
     */
    clientSendCommand(clientArray: number[], ID: _EClientCommand, param?: string): boolean;
     ...
     * @returns true if the operation succeeded
     */
    userModify(user: _rrUserSettings): boolean;
     ...
     * @returns true if the operation succeeded
     */
    userNew(user: _rrUserSettings): boolean;
}
...
interface _rrTCPuser {
     ...
     */
    at(userID: number): _rrUserSettings;

    /**
     * @returns a new user Preset
     */
    getNewUserPreset(): _rrUserSettings;

    /**
     * @returns a new anonymous user preset
     */
    getAnonymous(): _rrUserSettings;

    /**
     * @returns the currently logged in user
     */
    getOurUser(): _rrUserSettings;
...
interface _rrTCPjobList {
     ...
     */
    getJobDataType(jobID: rrUint64): _EdataIDs;
     ...
     */
    getJobMinInfo(jobID: rrUint64): _JobMinInfo;
     ...
     */
    getJobBasic(jobID: rrUint64): _JobBasics;
     ...
     */
    getJobSend(jobID: rrUint64): _JobSend;
     ...
     */
    getJobUpdatedTime(jobID: rrUint64): Date;
     ...
     */
    getJobMinInfo_queue(ID: number): _JobMinInfo;
     ...
     */
    getJobMinInfo_filterQueue(ID: number): _JobMinInfo;
}
...
interface _rrTCPclientList {
     ...
     */
    at(clientID: number): _ClientStatus;
    /**
